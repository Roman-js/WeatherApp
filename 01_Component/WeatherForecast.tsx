        ...
        <ImageBackground source={backgroundImg} style={styles.backgroundImage}>
            <View style={styles.forecastBox}>
                ...
                <View style={styles.forecasts}>
                    ...
                    <Button variant={"contained"} style={{backgroundColor: '#3d4a5d', color: 'white'}}
                            onClick={getForecastForTomorrow}>перейти</Button>
                ...
                <View style={styles.forecasts}>
                    ...
                    <Button variant={"contained"} style={{backgroundColor: '#3d4a5d', color: 'white'}}
                            onClick={getForecastForThreeDays}>перейти</Button>
                </View>
                <View style={styles.forecasts}>
                    <Text style={{textAlign: 'center'}}>Прогноз на 7 дней </Text>
                    <Button variant={"contained"} style={{backgroundColor: '#3d4a5d', color: 'white'}}
                            onClick={getForecastForSevenDays}>перейти</Button>
                </View>
